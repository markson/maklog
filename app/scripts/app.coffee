...
Em.Handlebars.registerBoundHelper 'markdown', (input) ->
  new Handlebars.SafeString(converter.makeHtml(input))

Em.Handlebars.registerBoundHelper 'highlight', (input) ->
  new Handlebars.SafeString("<span class='highlight'>#{input}</span>")
